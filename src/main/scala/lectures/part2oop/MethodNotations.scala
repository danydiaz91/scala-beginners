...
object MethodNotations extends App {
  ...
  class Person(val name: String, favoriteMovie: String, age: Int) {
    ...
    def +(text: String): String = s"${this.name} $text"
    ...
    def apply(times: Int): String = s"$name watched $times $favoriteMovie"
  ...
  /*
    ...
    3. Add a "learns" method in the Person class => "Mary learns Scala"
      Add a learnScala method, calls learns methods with "Scala".
